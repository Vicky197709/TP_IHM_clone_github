        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-10">
            <div className="flex items-center">
              <svg className="h-8 w-8 mr-2" fill="currentColor" viewBox="0 0 16 16">
          ...
          <div className="flex items-center space-x-4">
            <button className="text-sm hover:text-gray-300 hidden lg:block">
              Sign in
            </button>
            <button className="bg-gray-800 hover:bg-gray-700 px-3 py-1 rounded-lg text-sm hidden lg:block">
              Sign up
            </button>
